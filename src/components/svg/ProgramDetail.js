var ProgramDetail = `<svg width="120" height="150" viewBox="0 0 120 150" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<g mask="url(#mask0)">
<path fill-rule="evenodd" clip-rule="evenodd" d="M6 81C6 81 21.21 34 37 81C37 81 47.41 60 59 81H6ZM41 54C42.6569 54 44 55.3431 44 57C44 58.6569 42.6569 60 41 60C39.3431 60 38 58.6569 38 57C38 55.3431 39.3431 54 41 54V54Z" fill="#89969F"/>
</g>
